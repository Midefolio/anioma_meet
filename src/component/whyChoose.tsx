  ...
  return (
    <>
      ...
      >
       ...
       <div className="my-col-11 down-2 xs-11 md-11 rad-20 my-b-shadow h-card my-bottom-50">
          <div className="my-col-10 off-1 down-5 xs-10  xs-off-1 xs-down-8 md-10 md-off-1 md-down-8 col-d-1">
           <div><span className="icons bg-red white interBold">01</span></div>
       ...
       <div className="my-col-11 down-2 xs-11 md-11 rad-20 my-b-shadow h-card my-bottom-50">
          <div className="my-col-10 off-1 down-5  xs-10 xs-off-1 xs-down-8 md-10 md-off-1 md-down-8 col-d-1">
           <div><span className="icons white bg-red interBold">02</span></div>
       ...
       <div className="my-col-11 down-2 xs-11 md-11 rad-20 my-b-shadow h-card my-bottom-50">
          <div className="my-col-10 off-1 down-5  xs-10 xs-off-1 xs-down-8 md-10 md-off-1 md-down-8 col-d-1">
           <div><span className="icons white bg-red interBold">03</span></div>
           <div className="my-mother down-2 xs-down-5 md-down-5"><span className="px13 md-px20 xs-px20 poppings-Bold">Quality You Can Trust</span></div>
       ...
       <div className="my-col-11 down-2 xs-11 md-11 rad-20 my-b-shadow h-card my-bottom-50">
          <div className="my-col-10 off-1 down-5  xs-10 xs-off-1 xs-down-8 md-10 md-off-1 md-down-8 col-d-1">
           <div><span className="icons white bg-red interBold">04</span></div>
