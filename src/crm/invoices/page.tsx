...
import InvoiceTable from "./invoices_table";
import CrmLayouts from "../../component/crm_layouts";
// import ReceiptsTable from "./receipts_table";

const Invoices = () => {
  
  return (
    <>
      <CrmLayouts active="Invoices" />
          ...
          <div className="my-container down-5">
            <div className="gap-20">
              <div className="my-col-12">
                <span className="alice px13 InterSemiBold">All Invoices</span>
                <div>
                  <span className="px9 InterLight faded-sol">
                    {"Here's"} as overview of your Invoices
                  </span>
                </div>
              </div>
