           ...
           <div className="my-container down-5">
             <div className="gap-20">
                <div className="my-col-12">
                  <span className="alice px13 InterSemiBold">All Customers</span>
                  <div><span className="px9 InterLight faded-sol">{"Here's"} as overview of your customers</span></div>
                 ...
                 <div className="gap-20 my-col-4 right">
                  <span title="Theme" className="px13 pd-5 c-pointer icons"><AiOutlineSun/></span>
                  <span title="Logout" className="px12 pd-5 c-pointer icons"><AiOutlineLogout/></span>
                  <div>
                   <span className="px13 interBold">Your <br /> Team Members</span>
                    ...
                    <span className="mg-10 px8 c-pointer my-b-shadow pd-5 color-code-1 bg-color-code-3 rad-30 InterSemiBold">View All</span>
                   </div>
                 </div>
                </div>
             </div>
              {/* customer table */}
             <div className="my-mother down-5"> <CustomersTable/></div>
